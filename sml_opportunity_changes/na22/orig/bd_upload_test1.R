setwd("/newvol/girish/blackduck")


changes_data <- read.csv("/newvol/girish/optscore/optum_production_scripts/V3/model_outputs/VFOpportunityChanges5a.csv", stringsAsFactors = FALSE)
act_data <- read.csv("/newvol/girish/optscore/optum_production_scripts/V3/model_outputs/ActivityForOpenOpps_a.csv", stringsAsFactors = FALSE)
...
.libPaths( c( .libPaths(), "/newvol/work/software/spark/spark-1.5.0-bin-hadoop2.6/R/lib") )
...
Sys.setenv(SPARK_HOME = "/newvol/work/software/spark/spark-1.5.0-bin-hadoop2.6")
.libPaths(c(file.path(Sys.getenv("SPARK_HOME"), "R", "lib"), .libPaths()))
Sys.setenv('SPARKR_SUBMIT_ARGS'='"--jars" "/newvol/girish/optscore/spark-salesforce-assembly-1.0.7.jar" "sparkr-shell"')
library(SparkR)
